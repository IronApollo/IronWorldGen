...
public final class IronBiomeJungle extends IronBiomeBase{
	

	public IronBiomeJungle() {
        super((BiomeBuilder) (new IronBiomeBase.BiomeBuilder()).a(WorldGenSurface.G, WorldGenSurface.v).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.JUNGLE).a(0.1F).b(0.2F).c(0.95F).d(0.9F).a(4159204).b(329011).a((String) null));
        this.a(WorldGenerator.JUNGLE_TEMPLE, WorldGenFeatureConfiguration.e);
...
//        BiomeDecoratorGroups.C(this); OVERRIDE JUNGLE TREES
        this.addJungleTree();
