...
public class IronBiomeJungleHills extends IronBiomeBase{
	
	public IronBiomeJungleHills() {
        super((BiomeBuilder) (new BiomeBuilder()).a(WorldGenSurface.G, WorldGenSurface.v).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.JUNGLE).a(0.45F).b(0.3F).c(0.95F).d(0.9F).a(4159204).b(329011).a((String) null));
